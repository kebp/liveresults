...
if ($_GET['method'] == 'getcompetitions') {
    ...
    echo ']}';
} elseif ($_GET['method'] == 'setcompetitioninfo') {
    $compid = $_POST['comp'];
    ...
    echo "{\"status\": \"OK\"";
} elseif ($_GET['method'] == 'createcompetition') {
...
} elseif ($_GET['method'] == 'getcompetitioninfo') {
    $compid = $_GET['comp'];
    ...
    foreach ($lastPassings as $pass) {
        ...
        $ret .=
            ...
            . "\",
					\"time\": \""
            . formatTime($pass['Time'], $pass['Status'], $RunnerStatus)
            . "\" }";
        $first = false;
    }
